...
import { ArrowLeft, PiggyBank } from '@lucide/vue';
...
const submit = () => {
    form.post(`/members/${props.member.id}/savings/deposit`);
};
                ...
                <div class="mt-4 space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold">
                            ₱{{ formatAmount(savingsAccount?.current_balance) }}
                        </p>
                    </div>
